...
function PacksPage() {
  ...
  const { packsToDisplay, totalFilteredPages, totalFilteredPacks } =
    useMemo(() => {
      ...
      return {
        packsToDisplay: packsForCurrentPage, // Filtra eventuali valori undefined
  ...
  const PaginationControls = () => {
    ...
    if (loading || totalFilteredPacks <= ITEMS_PER_PAGE) {
      return null;
    }
  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <>
          {/* NUOVO: Aggiungo i controlli di paginazione sopra la griglia */}
          <PaginationControls />
      ...
      {/* VECCHIA PAGINAZIONE RIMOSSA E SOSTITUITA CON IL COMPONENTE, ORA È SEMPRE DOPO LA GRIGLIA */}
      <PaginationControls />
    </>
  );
}
